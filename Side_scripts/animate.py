...
def run_donut():
    ...
    themes = [
        ...
        # Metallic (realistic shiny metal)
        [[(80, 80, 80), (180, 180, 180), (255, 255, 255)],
         [(40, 40, 40), (220, 220, 220), (255, 255, 255)]],

        # Studio Render (blender-like neutral)
        [[(60, 60, 70), (150, 150, 160), (240, 240, 250)],
         [(30, 30, 40), (180, 180, 200), (255, 255, 255)]],

        # Classic Mono (default white-grey)
        [[(30, 30, 30), (180, 180, 180), (255, 255, 255)],
         [(80, 80, 80), (200, 200, 200), (255, 255, 255)]],
        ...
        # Emerald Shine (green glassy)
        [[(10, 50, 30), (40, 180, 120), (200, 255, 220)],
         [(0, 80, 40), (60, 200, 150), (220, 255, 240)]],

        # Amethyst Fade (violet + lavender)
        [[(60, 30, 80), (160, 100, 200), (220, 180, 255)],
         [(40, 20, 100), (200, 120, 255), (240, 220, 255)]],
    ]
    ...
    while run:
        ...
        for theta_deg in range(0, 360, theta_spacing):
            ...
            for phi_deg in range(0, 360, phi_spacing):
                ...
                # Blending between palettes based on phi
                blend_factor = (math.sin(phi) + 1) / 2  # Smooth wave between 0 and 1

                # Blend each palette color
